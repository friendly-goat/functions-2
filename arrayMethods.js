...
let cp200 = monstersInYourPocket.filter(monst => monst.CP > 200)
console.log(cp200)
...
let bobsOrder = purchases.filter(order => order.owner === 'Bob')
//console.log(bobsOrder)
let bobsTotal = bobsOrder.reduce((acc, cv) => {
  return acc + cv.price
}, 0)
